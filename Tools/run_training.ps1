...
#
# Usage (from anywhere):
#   powershell -ExecutionPolicy Bypass -File D:\GAME_CORE\Tools\run_training.ps1
...
$Engine  = "C:\Program Files\Epic Games\UE_5.7\Engine\Binaries\Win64\UnrealEditor.exe"
$Project = "D:\GAME_CORE\GAME_CORE.uproject"
$Python  = "D:\GAME_CORE\Python\venv\Scripts\python.exe"
$PyDir   = "D:\GAME_CORE\Python"
$LogDir  = "D:\GAME_CORE\Tools\logs"
...
try {
    ...
    Stop-Pair $ue $py
    Write-Host "Cleaned up. Checkpoints live in D:\GAME_CORE\Python\checkpoints, TensorBoard logs in Python\tb_logs."
}
